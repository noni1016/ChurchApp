    ...
    return (
        <Container>
            ...
            <NumGroupMemCont>
                ...
                {isLeader && <Icon name="settings-outline" size={18} color={'black'} onPress={() => stackNavi.navigate('EditMembers', {groupType: 'Club', group: data, members: members, navigation: stackNavi})} />}
            </NumGroupMemCont>
