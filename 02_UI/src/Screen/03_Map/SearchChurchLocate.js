...
const SearchChurchLocate = ({route, navigation})=>{
    ...
    const showNessesaryStep = () => {
        ...
        {/* <Input
                ...
                <ChangeBtn onPress={() => {
                    ...
                    data.location_ll.x = location.longitude;
                    data.location_ll.y = location.latitude;

                    console.log("change");
                    console.log(data);

                    navigation.navigate('EditChurchPage', {churchData: data, navigation: navigation})
...
export default SearchChurchLocate;